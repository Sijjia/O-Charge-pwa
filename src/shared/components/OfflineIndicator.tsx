          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="mt-3 flex space-x-2">
              ...
              <button
                ...
                className="px-3 py-1 rounded text-xs font-medium bg-zinc-200 dark:bg-zinc-700 hover:bg-zinc-300 dark:hover:bg-zinc-600 text-zinc-600 dark:text-gray-300"
              >
                Свернуть
              </button>
            </div>
