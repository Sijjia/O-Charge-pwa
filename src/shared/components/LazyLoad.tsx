...
export const LazyLoad: React.FC<LazyLoadProps> = ({
  children,
  placeholder = <div className="animate-pulse bg-zinc-700 rounded-lg h-32" />,
  rootMargin = "100px",
  threshold = 0.1,
  onVisible,
  once = true,
  ...
  return (
    <div className={className}>
      {visibleItems.map((item, index) => (
        <div key={keyExtractor ? keyExtractor(item, index) : `lazy-item-${index}`} className={itemClassName}>
