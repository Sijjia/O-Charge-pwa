...
export const DEMO_BISHKEK_LOCATIONS: OwnerLocation[] = [
  ...
  {id:"loc-bsh-004",name:"АЗС O!Charge #12",   address:"ул. Ахунбаева 98",               city:"Бишкек",latitude:42.8534,longitude:74.6012,user_id:"demo-regional-operator-bishkek-001",admin_id:"",status:"active",      stations_count:1,created_at:"2025-09-01T00:00:00Z",updated_at:new Date().toISOString()},
  ...
  {id:"loc-bsh-008",name:"АЗС O!Charge #7",     address:"ул. Байтик Баатыра 2",           city:"Бишкек",latitude:42.8488,longitude:74.5855,user_id:"demo-regional-operator-bishkek-001",admin_id:"",status:"active",      stations_count:1,created_at:"2025-09-01T00:00:00Z",updated_at:new Date().toISOString()},
...
export const demoReserves = [
  ...
  { id: "rsv-004", station_id: "stn-bsh-008", user_id: "client-004", connector_number: 1, start_time: new Date(now - 5 * h).toISOString(),   end_time: new Date(now - 4 * h).toISOString(),   status: "completed", created_at: new Date(now - 5 * h).toISOString(),   station_name: "АЗС O!Charge #7 — ABB Terra AC",   user_phone: "+996500444004" },
  ...
  { id: "rsv-007", station_id: "stn-bsh-004", user_id: "client-007", connector_number: 1, start_time: new Date(now + 1 * h).toISOString(),   end_time: new Date(now + 2 * h).toISOString(),   status: "active",    created_at: new Date(now).toISOString(),              station_name: "АЗС O!Charge #12 — Delta DC Wallbox", user_phone: "+996770777007" },
