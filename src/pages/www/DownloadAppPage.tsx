  ...
  return (
    <div className="min-h-[70vh] flex flex-col items-center justify-center px-4 py-16">
      ...
      <div className="max-w-2xl w-full text-center">
        <div className="w-20 h-20 bg-[#f0047f] rounded-3xl flex items-center justify-center mx-auto mb-8 shadow-xl shadow-[#f0047f]/20">
        ...
        <div className="grid sm:grid-cols-3 gap-6 max-w-2xl mx-auto">
          {[
            ...
            <div key={f.title} className="text-center">
              <div className="w-12 h-12 bg-[#f0047f]/10 rounded-xl flex items-center justify-center mx-auto mb-3">
                <Icon icon={f.icon} width={24} className="text-[#f0047f]" />
              </div>
