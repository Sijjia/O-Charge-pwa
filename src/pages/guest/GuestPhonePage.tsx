...
export function GuestPhonePage() {
  ...
  return (
    <div className="bg-zinc-50 dark:bg-[#0A0E17] text-zinc-900 dark:text-white h-screen flex flex-col relative overflow-hidden selection:bg-[#f0047f]/30 transition-colors duration-300">
      {/* Decorative Top Gradient */}
      <div className="absolute top-0 inset-x-0 h-96 bg-gradient-to-b from-[#5c0030]/5 dark:from-[#5c0030]/10 via-zinc-100/5 dark:via-zinc-900/5 to-transparent pointer-events-none select-none" />
            ...
            <div
              className={`group relative bg-white dark:bg-zinc-900/50 rounded-2xl border transition-all duration-300 shadow-sm dark:shadow-none ${
                error
                  ...
                  : "border-zinc-200 dark:border-zinc-800 focus-within:border-[#f0047f]/50 focus-within:bg-zinc-50 dark:focus-within:bg-zinc-900 focus-within:shadow-[0_0_0_1px_rgba(239,68,68,0.2)]"
              }`}
          ...
          <button
            ...
            className={`group w-full h-14 text-white text-base font-medium rounded-xl flex items-center justify-center gap-2 px-6 transition-all duration-300 active:scale-[0.98] ${
              !isValid
                ...
                : "bg-[#f0047f] hover:bg-[#f0047f] shadow-lg shadow-[#5c0030]/20"
            }`}
          >
            <span>Далее</span>
            <Icon
