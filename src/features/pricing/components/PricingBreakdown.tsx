...
export function PricingBreakdown({ 
  ...
  return (
    <div className="bg-gradient-to-br from-white to-gray-50 rounded-xl border border-zinc-800 overflow-hidden">
      <div className="bg-zinc-800 px-4 py-3 border-b border-zinc-800">
      ...
      <div className="p-4 space-y-3">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 bg-yellow-500/15 rounded-lg flex items-center justify-center">
                <Icon icon="solar:bolt-linear" width={16} className="text-yellow-600" />
              </div>
              <div>
                <p className="text-sm font-medium text-gray-300">Электроэнергия</p>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 bg-blue-500/15 rounded-lg flex items-center justify-center">
                <Icon icon="solar:clock-circle-linear" width={16} className="text-blue-600" />
              </div>
              <div>
                <p className="text-sm font-medium text-gray-300">Время зарядки</p>
                <p className="text-xs text-gray-500">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 bg-purple-500/15 rounded-lg flex items-center justify-center">
                <Icon icon="solar:card-linear" width={16} className="text-purple-600" />
              </div>
              <div>
                <p className="text-sm font-medium text-gray-300">Плата за сессию</p>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 bg-orange-500/15 rounded-lg flex items-center justify-center">
                <Icon icon="solar:clock-circle-linear" width={16} className="text-orange-600" />
              </div>
              <div>
                <p className="text-sm font-medium text-gray-300">Плата за парковку</p>
                <p className="text-xs text-gray-500">
          ...
          <div className="flex items-center justify-between border-t pt-3">
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 bg-green-500/15 rounded-lg flex items-center justify-center">
                <Icon icon="solar:graph-down-linear" width={16} className="text-green-600" />
              </div>
              <div>
                <p className="text-sm font-medium text-green-400">Скидка</p>
                <p className="text-xs text-gray-500">
        ...
        <div className="border-t pt-3 mt-3">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-base font-semibold text-gray-300">Итого к оплате</p>
              {pricing.is_client_tariff && (
                <p className="text-xs text-purple-600 mt-1 flex items-center gap-1">
                  <Icon icon="solar:star-shine-linear" width={12} />
                  Специальный тариф
                </p>
              )}
            </div>
