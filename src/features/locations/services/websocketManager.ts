...
export class WebSocketManager {
  ...
  private async getWebSocketUrl(): Promise<string | null> {
    ...
    try {
      ...
      // В dev — используем proxy от текущего origin; в prod — VITE_WEBSOCKET_URL / VITE_WS_URL или VITE_API_URL (http->ws)
      const wsEnv = (import.meta.env?.["VITE_WEBSOCKET_URL"] || import.meta.env?.["VITE_WS_URL"]) as string | undefined;
