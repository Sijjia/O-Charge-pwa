...
export function QRScanner({ onScan, onError, onCancel }: QRScannerProps) {
  ...
  return (
    <div className="flex flex-col items-center space-y-4 p-4">
          ...
          <>
            ...
            {onCancel && (
              <button
                ...
                className="px-6 py-3 bg-zinc-700 text-gray-300 rounded-lg hover:bg-gray-300 transition-colors"
              >
                Отмена
              </button>
            )}
      ...
      <div className="mt-6 pt-6 border-t border-zinc-800 w-full max-w-sm">
